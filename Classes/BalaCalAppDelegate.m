...
{
	return [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"GCal.dispsett"];
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
	//NSLog(@"app did enter bkg");
    /*
     Use this method to release shared resources, save user data, invalidate timers, and store enough application state information to restore your application to its current state in case it is terminated later. 
     If your application supports background execution, called instead of applicationWillTerminate: when the user quits.
     */
	[appDispSettings writeToFile:[self dispAppSettingsFileName] atomically:YES];
}


- (void)applicationWillEnterForeground:(UIApplication *)application {
	//NSLog(@"app will enter foregrnd");
    /*
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    //NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"GCalLoc.sqlite"]];
...
{
	mainViewCtrl.myLocation.longitude = longitude;
	mainViewCtrl.myLocation.latitude = latitude;
	mainViewCtrl.myLocation.city = inCity;
	mainViewCtrl.myLocation.country = inCountry;
	mainViewCtrl.myLocation.timeZone = [NSTimeZone timeZoneWithName:inTimeZone];
	
	[mainViewCtrl storeMyLocation];
	[mainViewCtrl actionNormalView:self];
}
